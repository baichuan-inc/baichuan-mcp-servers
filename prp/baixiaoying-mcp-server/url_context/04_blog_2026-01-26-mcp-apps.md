...
URL Source: https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/

Published Time: 2026-01-26T00:00:00Z

Markdown Content:
MCP Apps - Bringing UI Capabilities To MCP Clients | Model Context Protocol Blog
===============

[Model Context Protocol Blog](http://blog.modelcontextprotocol.io/ "Model Context Protocol Blog (Alt + H)")
...
January 26, 2026·MCP Core Maintainers

Table of Contents

- [What Are MCP Apps?](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#what-are-mcp-apps)
- [How It Works](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#how-it-works)
- [Why MCP Apps?](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#why-mcp-apps)
- [The App API](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#the-app-api)
- [Security Model](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#security-model)
- [The Future of Agentic UI Frameworks](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#the-future-of-agentic-ui-frameworks)
- [Client Support](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#client-support)
- [Get Started](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#get-started)
  - [Resources](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#resources)
  - [Claude.ai Feedback](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#claudeai-feedback)
  - [ChatGPT Apps SDK Feedback](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#chatgpt-apps-sdk-feedback)

- [Acknowledgements](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#acknowledgements)
...
We proposed MCP Apps [last November](https://blog.modelcontextprotocol.io/posts/2025-11-21-mcp-apps/), building on the amazing work of [MCP-UI](https://mcpui.dev/) and the [OpenAI Apps SDK](https://developers.openai.com/apps-sdk/). We were excited to partner with both OpenAI and MCP-UI to create a shared open standard for providing affordances for developers to include UI components in their MCP clients.
...
[Get Started with MCP Apps →](https://modelcontextprotocol.github.io/ext-apps/api/documents/Quickstart.html)
**What Are MCP Apps?**[#](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#what-are-mcp-apps)
...
![Image 1: Color picker MCP App working in Claude.ai](https://blog.modelcontextprotocol.io/posts/images/mcp-apps/claude-colorpicker-apps.gif)
...
To build new MCP Apps, developers can use the [`@modelcontextprotocol/ext-apps`](https://www.npmjs.com/package/@modelcontextprotocol/ext-apps) package, which provides an `App` class for UI-to-host communication:
...
- **Visual Studio Code** - available in [Visual Studio Code Insiders](https://code.visualstudio.com/insiders)
...
This is just the starting lineup, and adding support to a new client is as easy as following the [implementation guide](https://modelcontextprotocol.io/docs/extensions/apps).
...
![Image 2: Color picker MCP App working in Visual Studio Code](https://blog.modelcontextprotocol.io/posts/images/mcp-apps/vscode-colorpicker-apps.gif)
...
### [**Claude.ai**](http://claude.ai/)**Feedback**[#](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#claudeai-feedback)

If you’re building MCP Apps for [Claude.ai](http://claude.ai/) and encounter issues with our implementation, please report them at [github.com/anthropics/claude-ai-mcp](https://github.com/anthropics/claude-ai-mcp). This helps us improve the experience for everyone.

### **ChatGPT Apps SDK Feedback**[#](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#chatgpt-apps-sdk-feedback)

If you’re building apps with the ChatGPT Apps SDK and run into issues or have questions, please post in the [ChatGPT Apps category](https://community.openai.com/c/chatgpt-apps-sdk/42) on the OpenAI Community forum. This is where app developers, community moderators, and the OpenAI team actively engage to discuss builds, troubleshoot problems, and improve the overall developer experience.
...
- [Mcp](http://blog.modelcontextprotocol.io/tags/mcp/)
- [Extensions](http://blog.modelcontextprotocol.io/tags/extensions/)
- [Apps](http://blog.modelcontextprotocol.io/tags/apps/)

Copyright © 2025 Model Context Protocol Project. All rights reserved.[](https://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/#top "Go to Top (Alt + G)")
